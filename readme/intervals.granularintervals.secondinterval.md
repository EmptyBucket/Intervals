...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [Interval&lt;DateTime&gt;](./intervals.intervals.interval-1.md) → [GranularInterval](./intervals.granularintervals.granularinterval.md) → [SecondInterval](./intervals.granularintervals.secondinterval.md)<br>
...
### **SecondInterval(Int32, Int32, Int32, Int32, Int32, Int32, DateTimeKind)**

```csharp
public SecondInterval(int year, int month, int day, int hour, int minute, int second, DateTimeKind kind)
```
...
`second` [Int32](https://docs.microsoft.com/en-us/dotnet/api/system.int32)<br>
